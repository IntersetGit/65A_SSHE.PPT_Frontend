...
import { Card , Space , Table , Form, Dropdown, Button, Menu, Input, Drawer, Tabs, Radio } from 'antd';
import { MoreOutlined, EditOutlined, DeleteOutlined, PlusOutlined } from '@ant-design/icons';
import { project_data } from '../../config/project_company';
...
const ProjectManage = (props) => {
    ...
    const AddProject = (type, _data = {}) => {
      ...
      switch (type) {
        case "ADD":
          console.log([...projectdata , {id : projectdata.length + 1 , key : projectdata.length + 1 , project_id : `Rp-00${projectdata.length + 1}` , ..._data}])
          setprojectdata([...projectdata , {id : projectdata.length + 1 , key : projectdata.length + 1 , project_id : `Rp-00${projectdata.length + 1}`, ..._data}])
          break;
    ...
    return(
        ...
        <Button type='primary' style={{ float : 'right' }} icon={<PlusOutlined />} onClick={() => showModal(1)} >เพิ่ม</Button>
            <Table 
            columns={columns}
                  ...
                  <Tabs defaultActiveKey="1">
                    <TabPane tab="โครงการ" key="1">
                      ...
                      <Form.Item
                        ...
                        name="active"
                      >
                        <Radio.Group options={options} onChange={RadioonChange} value={value} optionType="button" />
                      </Form.Item>
                    </TabPane>

                    <TabPane tab="ผู้รับเหมา" key="2">
                    </TabPane>
                  </Tabs>
