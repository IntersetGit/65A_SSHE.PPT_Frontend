...
const AnalysisReport: React.FC = () => (
  <PictureLoader source="Analysis-Report.png" />
);
...
const RiskIdentification: React.FC = () => (
  <PictureLoader source="Risk Identification.png" />
);
const RiskRegister: React.FC = () => (
  <PictureLoader source="Risk Register.png" />
);
const Security: React.FC = () => <PictureLoader source="security.png" />;
const SSHEAnalysis: React.FC = () => (
  <PictureLoader source="SSHE-Analysis.png" />
);
const SSHEGraph: React.FC = () => <PictureLoader source="SSHE-Graph.png" />;
const SSHEIncident: React.FC = () => (
  <PictureLoader source="SSHE-Incident.png" />
);
const SSHEissue: React.FC = () => <PictureLoader source="sshe-issue.png" />;
const SSHEStatistic: React.FC = () => (
  <PictureLoader source="SSHE-Statistic.png" />
);
...
let ICONMAP: IconMaptype = {
  enviroment: (
    <Icon component={Environment as React.ForwardRefExoticComponent<any>} />
  ),
  activity: (
    <Icon component={Activity as React.ForwardRefExoticComponent<any>} />
  ),
  activity2: (
    <Icon component={Activity2 as React.ForwardRefExoticComponent<any>} />
  ),
  'Analysis-Report': (
    <Icon component={AnalysisReport as React.ForwardRefExoticComponent<any>} />
  ),
  contractor: (
    <Icon component={Contractor as React.ForwardRefExoticComponent<any>} />
  ),
  contractor2: (
    <Icon component={Contractor2 as React.ForwardRefExoticComponent<any>} />
  ),
  ...
  mitigation: (
    <Icon component={Mitigation as React.ForwardRefExoticComponent<any>} />
  ),
  mitigation2: (
    <Icon component={Mitigation2 as React.ForwardRefExoticComponent<any>} />
  ),
  procedure: (
    <Icon component={Procedure as React.ForwardRefExoticComponent<any>} />
  ),
  ...
  'Risk Identification': (
    <Icon
      component={RiskIdentification as React.ForwardRefExoticComponent<any>}
    />
  ),
  'Risk Register': (
    <Icon component={RiskRegister as React.ForwardRefExoticComponent<any>} />
  ),
  security: (
    <Icon component={Security as React.ForwardRefExoticComponent<any>} />
  ),
  'SSHE-Analysis': (
    <Icon component={SSHEAnalysis as React.ForwardRefExoticComponent<any>} />
  ),
  'SSHE-Graph': (
    <Icon component={SSHEGraph as React.ForwardRefExoticComponent<any>} />
  ),
  'SSHE-Incident': (
    <Icon component={SSHEIncident as React.ForwardRefExoticComponent<any>} />
  ),
  'sshe-issue': (
    <Icon component={SSHEissue as React.ForwardRefExoticComponent<any>} />
  ),
  'SSHE-Statistic': (
    <Icon component={SSHEStatistic as React.ForwardRefExoticComponent<any>} />
  ),
